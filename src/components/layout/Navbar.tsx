...
export default function Navbar() {
  ...
  const openMenu = useCallback(() => {
    ...
    gsap.timeline({
      ...
      /* CLOSE label fades in */
      .to(closeLblRef.current, { opacity: 1, duration: 0.3, ease: 'power2.out' }, 0.3)
  ...
  /* ── Derived colours ── */
  /* When overlay is open the bar sits above the dark overlay → always use inverse */
  const textColor = isOpen || theme === 'dark' ? 'var(--text-inverse)' : 'var(--text-primary)'
  ...
  return (
    <>
      ...
      >
        ...
        {/* CLOSE label + hamburger — in a flex row */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>

          {/* "CLOSE" — always in layout, opacity-0 until menu opens */}
          <span
            ref={closeLblRef}
            style={{
      ...
      {/* ════════════════════════════════════════════
          Fullscreen overlay — z-99 (below nav bar)
      ════════════════════════════════════════════ */}
      <div
        ref={overlayRef}
        style={{
          ...
          <div onMouseLeave={() => setHoveredIdx(null)}>
            {NAV_LINKS.map(({ index, label, href }, i) => (
              ...
              >
                ...
                {/* Link text — overflow:hidden clips the slide-up animation */}
                <div style={{ overflow: 'hidden', paddingLeft: 52 }}>
                  <a
                    ...
                    style={{
                      ...
                      lineHeight: 0.9,
                      letterSpacing: '-0.04em',
                      color: hoveredIdx === i ? 'var(--accent)' : 'var(--text-inverse)',
